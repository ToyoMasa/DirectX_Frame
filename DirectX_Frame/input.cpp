...
//HRESULT InitInput(HINSTANCE hInstance, HWND hWnd)
//{
//	UNREFERENCED_PARAMETER(hWnd);			//現在は参照されない
//
//	if (g_pInput == NULL)
//	{
...
//	{
//		MessageBox(hWnd, "キーボードがみつかりませんでした。", "警告！", MB_ICONWARNING);
//		return E_FAIL;
//	}
//
//	// データフォーマットを設定
...
//	}
//
//	// キーボード(入力デバイス)へのアクセス権を獲得(入力制御開始)
...
//		g_pDevKeyboard->Unacquire();		//必ずリリースより先
//
...
//
//	// 入力処理の終了処理
//	UninitInput();		//もしマウスやパッドを使うなら全て終わってから呼ぶ
//}
//
////=============================================================================
//// キーボードの更新処理関数
